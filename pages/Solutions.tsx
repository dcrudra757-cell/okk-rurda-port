        ...
        {loading ? (
          ...
          <div className="space-y-32">
            {solutions.map((solution: any, idx: number) => (
              <div key={solution.id} className={`flex flex-col lg:flex-row gap-16 items-center animate-fade-in-up ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`} style={{ animationDelay: `${idx * 200}ms` }}>
                ...
                <div className="w-full lg:w-1/2 relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden aspect-[4/3] border border-white/10 bg-[#111] group hover:border-white/20 transition-all">
                      <img src={solution.image} alt={solution.title} loading="lazy" className="w-full h-full object-cover transition-all duration-700 group-hover:scale-105 opacity-80 group-hover:opacity-100" />
